...
public class ListEx {
    ...
    * 대표적인 클래스는 : ArrayList(조회 빠름), LinkedList(삽입, 삭제 빠름)
    *
    * 특징
    * 순서 존재 : 저장된 요소(값)들은 인덱스를 통해 0번 부터 저장되고, 순차적으로 접근
    * 중복 허용 : 동일한 요소(값)을 여러번 저장할 수 있음
    * 동적 크기 : 배열과 달리, 리스트는 크기가 (유)동적으로 변경될 수 있음
    * null허용  : null 값을 요소(값)으로 저장할 수 있음
    *
    * 주요 메서드(기능)
    ...
    *
    * int 자료형만 저장 가능한 변수 이름(int = Integer)
    ...
    * */
    ...
    public static void main(String[] args) {
        ...
        * 메로리 차이가 발생하는 부분은 ArrayList 객체 선언하는 부분이 아니라
