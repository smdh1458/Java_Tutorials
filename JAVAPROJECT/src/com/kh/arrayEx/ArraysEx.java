...
* deepEquals(2차원 이상의 배열 비교1변수명, 비교2변수명)   2차원 이상의 두 배열이 동일한지 비교
* */
public class ArraysEx {
    ...
    public void arr1DMethod(){
        ...
        System.out.println("모든 값을 오름차순으로 정렬: "+Arrays.toString(arr1));
        //오름차순으로 arr1이 제대로 정렬 됐는지 확인
        ...
        System.out.println("arr1과 배열의 값이 같은지 확인: "+a);
        //arr1의 값을 모두 7로 변경했기 때문에 arr2와 비교했을 때 false가 나옴
    }
