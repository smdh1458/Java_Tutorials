...
public class EmployeeServiceImpl implements EmployeeService {
    ...
    @Override
    public void updateEmployee(String emp_name, String email, String phone, String dept_code, String job_code, String sal_level, double salary, double bonus, String manager_id, Date ent_date, char emt_yn) {
    ...
    public void deleteEmployee(String emp_id, String emp_name, String email, char ent_yn) {
        ...
        if(employee != null) {//사원을 조회했을 때 조회한 정보가 존재한다면(빈값이 아닐때)
    ...
    public void viewEmployee(String emp_id, String emp_name, String email) {
        ...
        if(employee != null) { //조회하고자 하는 회원정보가 일치하는 사원이 존재할 때
    ...
    @Override
    public void viewEmployee(String info_emp) { //info_emp = emp_id 또는 emp_name 또는 emp_email 중 하나라도 일치하는 사원
    ...
    @Override
    public void viewEmployee(String emp_name, String email) { //동명이인일 경우 이름과 이메일이 일치하는 사원 정보 조회
