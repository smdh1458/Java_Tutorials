...
public class CarArrayPreService {
    public void carMethod1() {
        // Car 객체 배열을 생성    자동차 종류들을 담는 배열 생성
        CarArrayPre[] cars = {
        ...
        //toDo : 1.Arrays.toString을 이용해 cars 배열 출력
        ...
        * 반복 횟수를 줄이면서 정렬 완료
        *
        * compareTo 메서드 배열 내에 존재하는 문자열을 비교
        ...
        * */
        ...
        System.out.println("cars와 carsEquals 안에 들어있는 차들은 같은가? :"+ areEquals);
    }
