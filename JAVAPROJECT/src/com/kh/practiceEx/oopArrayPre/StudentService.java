...
public class StudentService {
    public static void main(String[] args) {
        ...
        * student2 와 student3
        *
        * student2 = if 문을 이용해 프론트엔드에서 전달받은 값을 한번 더 검증하고
        * DB에 전달된 값을 저장
        *
        ...
        * */
        ...
        if(inputName != null && inputName.length() <= 6) {
            ...
            System.out.println("이름은 6글자 이하이어야하고, 빈공간일수 없습니다.: "+inputName+"저장불가");
        }
        ...
        //매개변수 생성자를 이용해서 학생 3번은 이름 나이를 필수로 입력받되, idCard는 선택적으로 set을 이용해 추가
        ...
        studentsList.add(student2);    //오직 set으로만 저장된 학생 2 추가
        studentsList.add(student3);    //매개변수와 set으로 작성된 학생 3 추가

        System.out.println("학생증발급이 완료되었습니다.");
        System.out.println("====== 학생증 발급완료목록 ===== ");
        //for문을 이용해서 저장된 학생 출력 1. 일반 for문 2.향상된 for문 출력
