...
public class Student {
    ...
    //기본생성자: 객체를 처음 생성할때 () 파라미터명을 하나도 넣지 않겠다는 생성자
    public Student() {
    }
    ...
    public Student(String name, int age /*String idCard*/) {
        this.name = name;
        this.age = age;
        //this.idCard = idCard; idCard는 만들고싶은 학생만 선택적으로 만들고 DB에 만든 아이디 카드를 저장
    }

    //DB에 값을 저장할 때 선택할 수 있음
    //파라미터 생성자를 메서드를 이용해서 DB에 한번에 저장하는 방법
    //파라미터 생성자 주로 사용해서 저장할 때 = 회원가입에서 필수로 작성해야하는 값
